    ...
    <section class="content">
        <div class="box box-warning box-solid">
            <div class="box-header with-border">
                <h3 class="box-title">INPUT DATA MASTER_STOK_AGEN</h3>
			...
			<tr>
				<td>Kasir</td>
				<td><?php echo select2_dinamis_id('kode_m_kasir', 'tbl_user', 'full_name', 'id_users', "Nama Agen",'id_user_level',3) ?></td>
				<td>Tanggal</td>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		function tampil_data_barang(){
		    $.ajax({
		        type  : 'GET',
		        url   : '<?php echo base_url() ?>master_stok_agen/data_barang',
		        async : true,
		        dataType : 'json',
		...
		$('#show_data').on('click','.item_edit',function(){
            ...
            $.ajax({
                type : "GET",
                url  : "<?php echo base_url('master_stok_agen/get_barang') ?>",
                dataType : "JSON",
                data : {id:id},
                success: function(data){
		...
		$('#btn_simpan').on('click',function(){
            ...
            $.ajax({
                type : "POST",
                url  : "<?php echo base_url('master_stok_agen/simpan_barang') ?>",
                dataType : "JSON",
                data : {nostokkasir:nostokkasir, kode_barang:kode_barang , stok:stok},
                success: function(data){
		...
		$('#btn_update').on('click',function(){
            ...
            $.ajax({
                type : "POST",
                url  : "<?php echo base_url('master_stok_agen/update_barang') ?>",
                dataType : "JSON",
        ...
        $('#btn_hapus').on('click',function(){
            ...
            $.ajax({
            type : "POST",
            url  : "<?php echo base_url('master_stok_agen/hapus_barang') ?>",
            dataType : "JSON",
	...
	$(document).ready(function(){
			 $('#kode_barang').on('change',function(){
                ...
                $.ajax({
                    type : "POST",
                    url  : "<?php echo site_url('/master_stok_agen/get_stok') ?>",
                    dataType : "JSON",
