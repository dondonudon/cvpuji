...
<body class="hold-transition skin-blue sidebar-mini sidebar-collapse">
    <div class="wrapper">
        ...
        <header class="main-header">
            <!-- Logo -->
            <a href="<?php echo base_url() ?>kasir2" class="logo">
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li><a href="<?php echo base_url(); ?>kasir2_stock"><i class="fa fa-database" style="color:red"></i> <span>Master Barang</span></a></li>
                    <li><a href="<?php echo base_url(); ?>kasir2"><i class="fa fa-shopping-cart" style="color:green"></i> <span>Transaksi</span></a></li>
                    <li><a href="<?php echo base_url(); ?>kasir2_trans"><i class="fa fa-clone" style="color:yellow"></i> <span>Laporan</span></a></li>
                    <li><a href="<?php echo base_url(); ?>kasir2_mutasi"><i class="fa fa-newspaper-o" style="color:cyan"></i> <span>Mutasi</span></a></li>
