            ...
            <div class="col-xs-12">
                <div class="box box-warning box-solid">
                    ...
                    <div class="box-header">
                        ...
                        <button type="button" class="btn btn-primary" style="float: right;" onclick="window.location.href = '<?php base_url(); ?>kasir2/group';">MANUAL</button>
                    </div>
                    ...
                    <div class="box-body">
                        <div style="padding-bottom: 10px;">
                            ...
                            <form name="form" id="form" action="<?php base_url(); ?>kasir2/insert_trans" method="post" target="_blank">
                                Bayar &nbsp; &nbsp; &nbsp;
                                ...
                                <table>
                                    <tr>
                                        <!-- <td width="200px">
                            <input type="button" class="btn btn-block btn-warning btn-lg" onclick="location.href='<?php base_url(); ?>kasir2/group';" value="JUAL" />
                        </td>
                        <td>&nbsp;&nbsp;&nbsp;</td> -->
                                        <td width="200px">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $(document).on('change', '.table_data', function() {
            ...
            var value = $(this).val();
            $.ajax({
                url: "<?php echo base_url(); ?>kasir2/update",
                method: "POST",
                data: {
                    id_trans: id_trans,
        ...
        $(document).on('click', '.btn_delete', function() {
            ...
            if (confirm("Are you sure you want to delete this?")) {
                $.ajax({
                    url: "<?php echo base_url(); ?>kasir2/delete",
                    method: "POST",
                    data: {
                        id: id
                    },
    ...
    function load_data() {
        $.ajax({
            url: "<?php echo base_url(); ?>kasir2/json",
            dataType: "JSON",
            success: function(data) {
                var sum = 0;
    ...
    function countHrg(id) {
        ...
        var value = $("#" + id).val();
        $.ajax({
            url: "<?php echo base_url(); ?>kasir2/update_" + checkbox,
            method: "POST",
            data: {
                id_trans: id_trans,
                table_column: table_column,
