    ...
    fa-database {
      color: #2759AE;
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li><a href="<?php echo base_url(); ?>kasir1_stock"><i class="fa fa-database" style="color:red"></i> <span>Master Barang</span></a></li>
                <li><a href="<?php echo base_url(); ?>kasir1"><i class="fa fa-shopping-cart" style="color:green"></i> <span>Transaksi</span></a></li>
                <li><a href="<?php echo base_url(); ?>kasir1_trans"><i class="fa fa-clone" style="color:yellow"></i> <span>Laporan</span></a></li>
                <li><a href="<?php echo base_url(); ?>kasir1_mutasi"><i class="fa fa-newspaper-o" style="color:cyan"></i> <span>Mutasi</span></a></li>
