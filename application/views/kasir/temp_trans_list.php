<?php $this->load->view('kasir/_partial/head')?>
            <!-- content -->
                    ...
                    <div class="col-xs-12">
                        <div class="box box-warning box-solid">
                            ...
                            <div class="box-header">
                                ...
                                <button type="button" class="btn btn-primary" style="float: right;" onclick="window.location.href = '<?php base_url();?>kasir/group';">MANUAL</button>
                            </div>
            ...
            <table class="table table-striped table-bordered">
                ...
                <form name="form" id="form" action ="<?php base_url();?>kasir/insert_trans" method="post" target="_blank">
                Bayar &nbsp; &nbsp; &nbsp;
                ...
                <table>
                    <tr>
                        <!-- <td width="200px">
                            <input type="button" class="btn btn-block btn-warning btn-lg" onclick="location.href='<?php base_url();?>kasir/group';" value="JUAL" />
                        </td>
                        <td>&nbsp;&nbsp;&nbsp;</td> -->
                        <td width="200px">
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                $(document).on('change', '.table_data', function(){
                    ...
                    var value = $(this).val();
                    $.ajax({
                    url:"<?php echo base_url(); ?>kasir/update",
                    method:"POST",
                ...
                $.ajax({
                    type : "POST",
                    url  : "<?php echo base_url() ?>kasir/"+checkbox,
                    dataType : "JSON",
            ...
            function countHrg(id) {
                ...
                var value = $("#"+id).val();
                $.ajax({
                    url:"<?php echo base_url(); ?>kasir/update_"+checkbox,
                    method:"POST",
                    data:{id_trans:id_trans, table_column:table_column, value:value},
                    success:function(data)
                    {
        ...
        <script type="text/javascript">
            ...
            <!-- /.content-wrapper -->
            <?php $this->load->view('kasir/_partial/footer')?>
