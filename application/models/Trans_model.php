...
class Trans_model extends CI_Model
{
 ...
 public function get_datatables()
 {
  ...
  $query = $this->db->get();
  //$query = $this->db->query("SELECT t.notrans, t.kode_m_kasir, t.jumlah, DATE(t.datetime) as datetime, mk.nama FROM trans t INNER JOIN master_kasir mk ON t.kode_m_kasir=mk.kode_m_kasir");
  return $query->result();
 }
