...
class Master_stok_kasir_model extends CI_Model
{
 ...
 {
  $hasil = $this->db->query("INSERT INTO temp_master_stok_kasir (nostokkasir,kode_barang,stok,datetime)VALUES('$nostokkasir','$kode_barang','$stok','$datetime')");
  return $hasil;
 }
 ...
 public function insert_trans($notrans, $kode_m_kasir, $id_user, $datetime)
 {
  ...
  $q3 = $this->db->query("INSERT into master_stok_kasir (nostokkasir, kode_m_kasir, id_user, datetime) VALUES ('$notrans', '$kode_m_kasir', '$id_user', '$datetime')");
  //insert into master_stok_kasir_detail
  $q4 = $this->db->query("INSERT into master_stok_kasir_detail (nostokkasir, kode_barang, stok, min_stok, datetime) SELECT nostokkasir, kode_barang, stok, min_stok, datetime FROM temp_master_stok_kasir WHERE nostokkasir = '$notrans'");
