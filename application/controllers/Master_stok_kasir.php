...
class Master_stok_kasir extends CI_Controller
{
 public function __construct()
 {
  ...
  $this->session->set_flashdata('title', 'Master Stok Kasir | CV PUJI');
 ...
 public function get_stok()
 {
  ...
  $data         = $this->Master_stok_kasir_model->get_stok($kode_m_kasir, $kode_barang);
 ...
 public function simpan_barang()
 {
  ...
  $datetime    = date('Y-m-d H:i:s');
  $data        = $this->Master_stok_kasir_model->simpan_barang($kode_barang, $stok, $nostokkasir, $datetime);
  echo json_encode($data);
 }
 ...
 public function insert_trans()
 {
  ...
  $kode_m_kasir = $this->input->post('kode_m_kasir');
  $datetime     = date('Y-m-d H:i:s');
  $this->Master_stok_kasir_model->insert_trans($notrans, $kode_m_kasir, $id_user, $datetime);
  //   $this->print($notrans);
  //   $this->session->set_flashdata('message', 'Create Record Success 2');
...
/* End of file Master_stok_kasir.php */
