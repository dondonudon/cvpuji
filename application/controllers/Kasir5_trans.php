...
class kasir5_trans extends CI_Controller
{
 ...
 public function index()
 {
  ...
  $this->load->view('kasir/kasir5/trans_list', $data);
 ...
 public function ajax_list()
 {
  ...
  foreach ($list as $customers) {
   ...
   $row[] = '<a class="btn btn-sm btn-primary" href="' . base_url('kasir5_trans/read/' . $customers->notrans) . '" title="Edit" target="_blank">Detail</a>';
 ...
 public function read($notrans)
 {
  ...
  $this->load->view('kasir/kasir5/trans_read', $data);
