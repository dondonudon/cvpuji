...
class Stock_opname extends CI_Controller
{
 public function __construct()
 {
  ...
  $this->session->set_flashdata('title', 'Stock Opname | CV PUJI');
 ...
 public function simpan_barang()
 {
  ...
  $datetime      = date('Y-m-d H:i:s');
  $data          = $this->Stock_opname_model->simpan_barang($kode_barang, $stok, $nostockopname, $datetime);
  echo json_encode($data);
 }
 ...
 public function update_barang()
 {
  ...
  $stok            = $this->input->post('stok');
  $data            = $this->Stock_opname_model->update_barang($stok, $id_stock_opname);
  echo json_encode($data);
 }
 ...
 public function insert_trans()
 {
  ...
  $datetime = date('Y-m-d H:i:s');
  $this->Stock_opname_model->insert_trans($notrans, $id_user, $ket, $datetime);
  //   $this->print($notrans);
  //   $this->session->set_flashdata('message', 'Create Record Success 2');
