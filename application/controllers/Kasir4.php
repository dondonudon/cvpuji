...
class Kasir4 extends CI_Controller
{
  public $kode_m_kasir = 4;
  ...
  public function index()
  {
    ...
    $this->load->view('kasir/kasir4/temp_trans_list', $data);
  }
  ...
  public function group()
  {
    ...
    //$this->template->load('template','temp_trans/temp_trans_form', $data);
    $this->load->view('kasir/kasir4/temp_trans_group', $data);
  }
  ...
  public function barang()
  {
    ...
    //$this->template->load('template','temp_trans/temp_trans_form', $data);
    $this->load->view('kasir/kasir4/temp_trans_barang', $data);
  }
  ...
  public function single()
  {
    ...
    //$this->template->load('template','temp_trans/temp_trans_form', $data);
    $this->load->view('kasir/kasir4/temp_trans_single', $data);
  }
